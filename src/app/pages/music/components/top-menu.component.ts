...
import { lucideGlobe, lucideMic2 } from '@ng-icons/lucide';

import { HlmMenuBarComponent, HlmMenuBarItemDirective, HlmMenuComponent, HlmMenuGroupComponent, HlmMenuItemCheckboxDirective, HlmMenuItemCheckComponent, HlmMenuItemDirective, HlmMenuItemIconDirective, HlmMenuItemRadioComponent, HlmMenuItemRadioDirective, HlmMenuItemSubIndicatorComponent, HlmMenuLabelComponent, HlmMenuSeparatorComponent, HlmMenuShortcutComponent, HlmSubMenuComponent } from '../../../shared/components/_ui/ui-menu-helm/src';
		...
		<ng-template #edit>
			<hlm-menu variant="menubar" class="w-48">
				<hlm-menu-group>
					...
					<button hlmMenuItem>
						Smart Dictation...
						<hlm-menu-shortcut><hlm-icon size="sm" name="lucideMic2" /></hlm-menu-shortcut>
					</button>
					<button hlmMenuItem>
						Emoji & Symbols
